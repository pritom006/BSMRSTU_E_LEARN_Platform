...
class CourseSerializer(serializers.ModelSerializer):
    class Meta:
        model = models.Course
        fields = ['id','category','teacher','title', 'description','techs','featured_img','course_chapters','related_videos','tech_list','total_enrolled_students','course_rating','course_views']
...
class AttempQuizSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','quiz','student','question','right_ans','add_time']
